...
class Apriori(object):
    ...
    def generate_rules(self, min_conf=0.0):
        ...
        for i in range(1, len(self.freq_sets)):
            for freq_set in self.freq_sets[str(i + 1)]:  # 对于每一个频繁项集的集合
